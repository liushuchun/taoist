...
namespace cnn {
    ...
    struct Graph {
        ...
        inline unsigned add_function(const std::initializer_list<unsigned> &arguments, const std::string &name = "");
    ...
    struct Line {
        ...
        virtual Matrix
        backward(const std::vector<const Matrix *> &xs, const Matrix &fx, const Matrix &dEdf, unsigned i) const =0;
